#!/usr/bin/env python3
"""
Load fine-tuned law model - Handles bitsandbytes error gracefully
"""
import torch
...
# Redirect stderr to suppress bitsandbytes error messages
...
# Load base model (suppress bitsandbytes errors)
print("\n1. Loading base model...")
print("(Bitsandbytes errors are harmless - ignoring them)")
